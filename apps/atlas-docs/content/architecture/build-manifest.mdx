...
**Next milestone:** M4 — About + Contact (do not expand beyond Manifest scope)
...
| **M4 — About + Contact** | Profile + form | M0 · architecture freeze | `/about`, `/contact` | Matches 20/23; form delivers | Cleared to start — not started |
...
**Architecture frozen at v1.0 (M0–M3).** M4 (About + Contact) may begin. Do not start Docs, additional case studies, or Strapi integration as side quests outside Manifest order.
