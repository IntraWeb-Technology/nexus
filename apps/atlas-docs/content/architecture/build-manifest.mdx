...
| --- | --- |
| Visual identity & page composition | **Effective 2026-08-27:** Figma **Page 28 / Story-First** for the scoped surfaces below. Pages 15–26 (frozen) + **Page 27 Approval Polish (§29)** remain controlling where they do not overlap that scope. See also [`docs/governance/authority-map.md`](../../../../docs/governance/authority-map.md). |
...
Homepage visual evidence must settle `Reveal` content before it can be considered representative. Tracked Playwright snapshots remain unapproved. Canonical viewport definitions remain missing.
...
| 25 Editorial Image Direction | Evidence imagery; Story-First PHOTO gradient placeholders are **not** approved final media |
...
- **Articles (`/articles`, `/articles/[slug]`):** **M5 COMPLETE** for publishing primitives. **As of 2026-08-27:** Articles **index** visual authority is Page 28 / Story-First; **article-detail bodies** remain Figma Page 26. See [Editorial Publishing (M5)](/docs/architecture/editorial-publishing).
...
The Articles index must preserve Atlas editorial hierarchy (e.g. featured writing, chronological writing, editorial metadata, restrained topic/category navigation, selective imagery). **Forbidden shortcut:** regressing into a generic developer-blog / card-grid aesthetic. **As of 2026-08-27** the Articles index visual authority is Page 28 / Story-First; article-detail bodies remain Page 26.
...
| # | Item | YES/NO |
| --- | --- | --- |
| 1 | Design frozen (Figma 15–26; Page 28 / Story-First supersedes overlapping scoped surfaces as of 2026-08-27 — design direction only, parity unverified) | YES (authority recorded; implementation parity **not** verified) |
...
- ✓ Playwright D/T/M + axe + visual baselines (win32 + linux) — **historical presence only; snapshots remain unapproved** (Page 28 does not approve baselines; homepage captures must settle `Reveal` before they are representative)
