...
export const portfolioOsCaseStudy: CaseStudyFixture = {
  ...
  figures: {
    hero: {
      ...
      alt: "Portfolio OS case-study decisions chapter — engineering reasoning composition on the production surface",
      caption:
    ...
    implementationPrimary: {
      ...
      alt: "Atlas documentation handbook implementing the editorial brand system — categories, search, and guide index",
      caption:
        "Fig. 3 — Editorial Brand System applied to the handbook production surface.",
      captionShort: "Fig. 3 — Brand system on the handbook surface.",
      tone: "ink",
    ...
    implementationUi: {
      id: "fig-4",
      kind: "figma-artifact",
      alt: "Chapter marker and title micro-hierarchy close-up from the Decisions chapter",
    ...
    implementationWorkflow: {
      ...
      tone: "ink",
      // Rendered by ContentMapRenderDiagram — composed UI, not raster.
    },
    implementationTablet: {
      id: "fig-3-tablet",
      kind: "browser-capture",
      alt: "Brand system on the handbook reference at tablet width",
      caption: "Fig. 3 — Brand system on the handbook reference.",
      tone: "ink",
    ...
    implementationMobile: {
      id: "fig-3-mobile",
      kind: "browser-capture",
      alt: "Brand system on the handbook reference at mobile width",
