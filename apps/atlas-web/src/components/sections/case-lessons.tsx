...
type CaseLessonsProps = {
  data: CaseStudyFixture["lessons"];
};

export function CaseLessons({ data }: CaseLessonsProps) {
  return (
    <section
      id="lessons"
      aria-labelledby="case-lessons-title"
