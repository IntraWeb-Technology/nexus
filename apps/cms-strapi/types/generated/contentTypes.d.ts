...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog and long-form articles';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    originalSource: Schema.Attribute.String;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Article authorship';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client and portfolio case studies';
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Portfolio and product projects';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    projectType: Schema.Attribute.Enumeration<
      ['web-app', 'mobile-app', 'desktop-app', 'api', 'library', 'other']
    > &
...
export interface ApiRedirectRedirect extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'URL redirects per site';
  ...
  attributes: {
    ...
    site: Schema.Attribute.Relation<'manyToOne', 'api::site.site'> &
      Schema.Attribute.Required;
    sourcePath: Schema.Attribute.String & Schema.Attribute.Required;
    statusCode: Schema.Attribute.Enumeration<
      ['http_301', 'http_302', 'http_307', 'http_308']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'http_301'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Per-site SEO, logos, contact, and navigation';
  ...
  attributes: {
    ...
    footerNavigation: Schema.Attribute.Relation<
      ...
      'api::navigation.navigation'
    >;
    headerNavigation: Schema.Attribute.Relation<
      'oneToOne',
      'api::navigation.navigation'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSiteSite extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Multi-site ownership root';
    displayName: 'Site';
    pluralName: 'sites';
    singularName: 'site';
  };
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Article and project tags';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
...
export interface ApiTechnologyTechnology extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Technologies used across projects and services';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client and peer testimonials';
