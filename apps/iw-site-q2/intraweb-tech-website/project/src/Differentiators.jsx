function Differentiators() {
  ...
  return (
    <section id="differentiators" data-screen-label="05 Differentiators" style={{ padding: '140px 0', position: 'relative' }}>
      <div className="container">
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 48 }}>
          <span className="section-marker">[ 05 — WHAT SETS US APART ]</span>
          <span className="section-marker">// vs adjacent categories</span>
        </div>

        <Reveal>
          <Eyebrow>Positioning</Eyebrow>
          <h2 style={{ fontSize: 'clamp(36px, 4.5vw, 64px)', letterSpacing: '-0.03em', lineHeight: 1.05, fontWeight: 700, marginTop: 20, maxWidth: 1000 }}>
            Not a consultancy.<br/>
            Not a dev shop.<br/>
            <span style={{
              background: 'linear-gradient(95deg, var(--accent), var(--iw-amber))',
              WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
            }}>The implementation layer.</span>
          </h2>
        </Reveal>
            ...
            <Reveal key={i} delay={i * 100}>
              <div style={{
                ...
                <div style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: 10, marginBottom: 32 }}>
                  {c.accent
                    ? <span style={{ width: 10, height: 10, borderRadius: 2, background: 'var(--accent)', boxShadow: '0 0 12px var(--accent)' }}/>
