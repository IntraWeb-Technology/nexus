...
export const metadata: Metadata = {
  ...
  description: "How IntraWeb Technologies collects, uses, and protects your personal information.",
  alternates: {
    canonical: "/privacy",
  },
};
...
export default function PrivacyPage() {
  return (
    <LegalPageLayout eyebrow="Legal" title="Privacy Policy" lastUpdated="April 2026" showToc>
      <h2 id="introduction">Introduction</h2>
      <p>
        IntraWeb Technologies LLC (&ldquo;IntraWeb,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;)
        respects your privacy and is committed to protecting your personal information. This Privacy Policy explains
        how we collect, use, disclose, and safeguard your information when you visit our website intrawebtech.com or
        engage our services.
      </p>
      <p>
        Please read this Privacy Policy carefully. By accessing or using our website or services, you acknowledge that
      ...
      <p>
        We collect this information using cookies and similar tracking technologies. See our Cookie Policy section
      ...
      <p>Required for the website to function properly. These cannot be disabled. They include cookies for:</p>
      <ul>
      ...
      <p>
        Help us understand how visitors interact with our website. We use these to improve our site and services. These
      ...
      <p>
        Used to deliver relevant content and measure the effectiveness of our marketing efforts. These are only
        activated with your consent.
      </p>

      <h3>Managing Your Cookie Preferences</h3>
      <p>
        You can manage your cookie preferences at any time by clicking the &ldquo;Cookie Preferences&rdquo; link in our
        website footer or adjusting your browser settings.
      </p>
      ...
      <p>
        ...
        to protect the rights, property, or safety of IntraWeb, our clients, or others.
      </p>
      ...
      <p>
        For clients, we retain engagement records and related documentation for seven years following the completion of
        services, as required for business and legal purposes.
      </p>
      ...
      <p>
        ...
        transferred to, stored, and processed in the United States. By using our website or services, you consent to
        this transfer.
      </p>
      ...
      <p>
        ...
        We will notify you of any material changes by posting the updated policy on our website with a new &ldquo;Last
        updated&rdquo; date.
      </p>
      ...
      <p>
        ...
        <br />
        Email: <a href="mailto:privacy@intrawebtech.com">privacy@intrawebtech.com</a>
        <br />
