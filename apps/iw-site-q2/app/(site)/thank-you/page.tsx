      ...
      <main className="bg-gray-900 text-white min-h-screen flex items-center justify-center px-4">
        ...
        <div className="relative max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-4">
            <p className="text-xs uppercase tracking-[0.35em] text-teal-300">Message received</p>
            <h1 className="text-4xl md:text-5xl font-heading font-bold">Thank you</h1>
            <p className="text-xl text-gray-300">
              We received your note and will respond within one business day with a next step, or an honest answer if
...
function ThankYouContent() {
  ...
  const form: "intake" | "contact" | null =
    formParam === "contact" ? "contact" : formParam === "intake" ? "intake" : null;
...
export default function ThankYouPage() {
  return (
    <Suspense
      fallback={<ThankYouView form={null} scheduled={null} bookedViaApi={null} startIso={null} />}
    >
      <ThankYouContent />
    </Suspense>
  );
