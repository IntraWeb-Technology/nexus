...
/**
 * Constant-time string compare. Returns false when either side is empty
 * or lengths differ (avoids throwing from `timingSafeEqual`).
 */
...
/** Webhook secret from `x-strapi-webhook-secret` or Authorization. */
