![Nexus â€” IntraWeb Technology monorepo](./docs/assets/nexus-readme-banner.webp)
...
```text
Detect affected â†’ lint + typecheck + unit tests + build â†’ Atlas fixture E2E when applicable â†’ CI Gate
```
...
```text
.
â”œâ”€â”€ apps/                 # Deployable products and independently tooled app trees
â”œâ”€â”€ packages/             # Shared contracts, integrations, configuration, and operations
â”œâ”€â”€ docs/                 # Architecture, governance, automation, audit, and runbooks
â”œâ”€â”€ .github/              # Affected detection, CI, deployment, and contribution templates
â”œâ”€â”€ AGENTS.md             # Repository-wide agent and development guidance
â”œâ”€â”€ pnpm-workspace.yaml   # Root workspace membership and explicit exclusions
â””â”€â”€ turbo.json            # Task graph, cache outputs, and environment allowlists
```
